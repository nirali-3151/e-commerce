...
exports.getTotalCount = (req, res, next) => {
    const { p_sub_catagory_id } = req.query
    const sql = `SELECT count(*) FROM products WHERE p_sub_catagory_id = '${p_sub_catagory_id}'`
...
exports.viewProductFirstPage = (req, res, next) => {
    const { p_sub_catagory_id ,cart_id} = req.query
    var sql = `SELECT * from products WHERE p_sub_catagory_id = '${p_sub_catagory_id}' ORDER BY product_id LIMIT ` + numPerPage
