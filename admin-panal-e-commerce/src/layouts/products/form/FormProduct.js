...
import { Number, romanNumber, KG, Gram, Liter } from './sizeList'
                ...
                <MDBox mb={0} pr={2.5}>
                    ...
                    <MDBox mb={2}>
                        <FormControl fullWidth variant="outlined">
                            ...
                            {props.errors.size.length > 0 && <span className='error'>{props.errors.size}</span>}
                        </FormControl>
                    </MDBox>
                        ...
                        <MDBox mb={2.5}>
                            <div className="add-propduct-image-select">
                                ...
                                <div className="add-propduct-image-select-right-side">
                                    {_.isEmpty(image_name) ? "select images" :
