                ...
                <MDBox mb={2} pr={2.5}>
                    <MDBox mb={2}>
                        <FormControl fullWidth variant="outlined">
                            <InputLabel htmlFor="outlined-adornment-dName">Catagory Name</InputLabel>
                            <OutlinedInput
                                id="outlined-adornment-dName"
                                name="catagory_name"
                                value={props.data.catagory_name}
                    ...
                    <MDBox mb={2} justifyContent="center">
                        ...
                        >
                            ...
                            {props.data.thumb_nail_image !== "" ?
                                <div className='preview_img' >
                                    {!props.updateFlag ?
                                        <>
                                            <img
                                                src={URL.createObjectURL(props.data.thumb_nail_image)}
                                                alt="Thumb"
                                                className='cover2'
                                        ...
                                        :
                                        <>
                                            {typeof (props.data.thumbNail_image) === 'undefined' ?
                                                <img src={`${props.data.thumb_nail_image}`} className="cover2 " style={{ borderRadius: "8px" }} />
                                                : ""}

                                            {props.data.thumbNail_image && (
                                                <img
                                                    src={URL.createObjectURL(props.data.thumbNail_image)}
                                                    alt="Thumb"
                                                    className='cover2'
                                                    style={{ borderRadius: "8px" }}
                                                />
                    ...
                    <MDBox pt={3} pb={2}>
                        <MDBox
                            ...
                            <MDTypography variant="h6" color="white" align="center">
                                {!props.updateFlag ? "Add catagories" : "Update catagories"}
                            </MDTypography>
                        </MDBox>
                    </MDBox>
                </MDBox>
